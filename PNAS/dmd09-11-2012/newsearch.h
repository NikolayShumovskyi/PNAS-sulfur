...
1. Every cell has a list of atoms (clist). When the atom oves from
one cell to the next it is represented by collision with atoms search.n search.n+1 search.n+2
which corresponds to cossing x, y, and z sides of the cell.
